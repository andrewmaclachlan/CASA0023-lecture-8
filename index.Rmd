...
`r fa("twitter", fill = "#562457")`
[andymaclachlan](https://twitter.com/andymaclachlan)
`r fa("globe", fill = "#562457")` [andymac.uk](https://www.andymac.uk/)
...
[Ironic car advert](https://www.youtube.com/watch?v=RYn8aQIpNH4)
...
```{r echo=FALSE, out.width='48%', fig.align='center'}
  knitr::include_graphics('img/oxford_street.png')
```
.small[Source:[BBC](https://www.bbc.co.uk/news/articles/c3dvx4e3jryo)
]
...
* Is this Green washing ? You decide...
...
If you had £500,000 to improve cycle lanes [access to parks or anything...] would you:

* Target the most used roads without lanes: **"optimise" investment** with *data* and maximise usage 

* Target an equal distribution of cycle lanes across the area: **Equality**  

* Identify areas where there are fewer cycle lanes and invest: **Equity**

* Identify areas where there are fewer lanes and uptake is low and ensure access (e.g. bike sharing / bike schemes) is affordable and attainable: **Social justice**

> Do wealthier neighbourhoods have better access to cycle lanes? - [*Bicycle paths and greenery are concentrated in affluent neighborhoods* in Montreal](https://phys.org/news/2022-10-bicycle-paths-greenery-affluent-neighborhoods.html)

> Does this make a positive feedback loop ? [Why being close to a cycle network can boost house prices](https://theconversation.com/why-being-close-to-a-cycle-network-can-boost-house-prices-244084#:~:text=The%20Danish%20example%20shows%20that,creating%20a%20positive%20feedback%20loop.)
